...
<h2>Delete the Class for ${gymname}</h2>

	<form:form action="${contextPath}/classes/modify.htm"
		method="post">
		...
		<table>
			...
			<tr>
				<td colspan="2"><input class = "btn btn-success" type="submit" value="Delete Class" /></td>
			</tr>
		</table>
